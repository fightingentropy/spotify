    ...
    <section className="rounded-lg border border-white/[0.12] bg-white/[0.04] p-4">
      ...
      <dl className="grid gap-3 text-sm sm:grid-cols-2">
        <div className="rounded-md bg-black/20 p-3">
          ...
          <dd className="mt-1 font-medium">{formatBytes(storageUsage)}</dd>
        </div>
        <div className="rounded-md bg-black/20 p-3">
          <dt className="text-white/[0.55]">Quota</dt>
          <dd className="mt-1 font-medium">{storageQuota ? formatBytes(storageQuota) : "Unknown"}</dd>
        </div>
        <div className="rounded-md bg-black/20 p-3">
          <dt className="text-white/[0.55]">Persistent storage</dt>
          <dd className="mt-1 font-medium">
            {persistentStorage == null ? "Not reported" : persistentStorage ? "Granted" : "Best effort"}
          </dd>
        </div>
        <div className="rounded-md bg-black/20 p-3">
