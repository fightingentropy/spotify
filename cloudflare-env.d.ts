/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9e1da272f903fa3af14f6009935b2c61)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* waveform */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_TRUST_HOST" | "NEXTJS_ENV">> {}
}
